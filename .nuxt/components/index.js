...
export const LazyCodeGroup = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/base/CodeGroup.vue' /* webpackChunkName: "components/code-group" */).then(c => c.default || c)
export const LazyCodeSandbox = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/base/CodeSandbox.vue' /* webpackChunkName: "components/code-sandbox" */).then(c => c.default || c)
export const LazyList = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/base/List.vue' /* webpackChunkName: "components/list" */).then(c => c.default || c)
export const LazyBuiltWithNuxtDark = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/BuiltWithNuxtDark.vue' /* webpackChunkName: "components/built-with-nuxt-dark" */).then(c => c.default || c)
export const LazyBuiltWithNuxtLight = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/BuiltWithNuxtLight.vue' /* webpackChunkName: "components/built-with-nuxt-light" */).then(c => c.default || c)
export const LazyIconArrowLeft = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconArrowLeft.vue' /* webpackChunkName: "components/icon-arrow-left" */).then(c => c.default || c)
export const LazyIconArrowRight = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconArrowRight.vue' /* webpackChunkName: "components/icon-arrow-right" */).then(c => c.default || c)
export const LazyIconBadgeCheck = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconBadgeCheck.vue' /* webpackChunkName: "components/icon-badge-check" */).then(c => c.default || c)
export const LazyIconCheckCircle = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconCheckCircle.vue' /* webpackChunkName: "components/icon-check-circle" */).then(c => c.default || c)
export const LazyIconChevronRight = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconChevronRight.vue' /* webpackChunkName: "components/icon-chevron-right" */).then(c => c.default || c)
export const LazyIconClipboardCheck = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconClipboardCheck.vue' /* webpackChunkName: "components/icon-clipboard-check" */).then(c => c.default || c)
export const LazyIconClipboardCopy = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconClipboardCopy.vue' /* webpackChunkName: "components/icon-clipboard-copy" */).then(c => c.default || c)
export const LazyIconExclamationCircle = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconExclamationCircle.vue' /* webpackChunkName: "components/icon-exclamation-circle" */).then(c => c.default || c)
export const LazyIconExternalLink = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconExternalLink.vue' /* webpackChunkName: "components/icon-external-link" */).then(c => c.default || c)
export const LazyIconGithub = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconGithub.vue' /* webpackChunkName: "components/icon-github" */).then(c => c.default || c)
export const LazyIconInformationCircle = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconInformationCircle.vue' /* webpackChunkName: "components/icon-information-circle" */).then(c => c.default || c)
export const LazyIconMenu = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconMenu.vue' /* webpackChunkName: "components/icon-menu" */).then(c => c.default || c)
export const LazyIconMoon = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconMoon.vue' /* webpackChunkName: "components/icon-moon" */).then(c => c.default || c)
export const LazyIconSearch = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconSearch.vue' /* webpackChunkName: "components/icon-search" */).then(c => c.default || c)
export const LazyIconSun = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconSun.vue' /* webpackChunkName: "components/icon-sun" */).then(c => c.default || c)
export const LazyIconTranslate = import('../../node_modules/@nuxt/content-theme-docs/src/components/global/icons/IconTranslate.vue' /* webpackChunkName: "components/icon-translate" */).then(c => c.default || c)
...
export const LazyAppGithubLink = import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppGithubLink.vue' /* webpackChunkName: "components/app-github-link" */).then(c => c.default || c)
export const LazyAppHeader = import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppHeader.vue' /* webpackChunkName: "components/app-header" */).then(c => c.default || c)
export const LazyAppLangSwitcher = import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppLangSwitcher.vue' /* webpackChunkName: "components/app-lang-switcher" */).then(c => c.default || c)
export const LazyAppNav = import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppNav.vue' /* webpackChunkName: "components/app-nav" */).then(c => c.default || c)
export const LazyAppPrevNext = import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppPrevNext.vue' /* webpackChunkName: "components/app-prev-next" */).then(c => c.default || c)
export const LazyAppSearch = import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppSearch.vue' /* webpackChunkName: "components/app-search" */).then(c => c.default || c)
export const LazyAppSearchAlgolia = import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppSearchAlgolia.vue' /* webpackChunkName: "components/app-search-algolia" */).then(c => c.default || c)
export const LazyAppToc = import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppToc.vue' /* webpackChunkName: "components/app-toc" */).then(c => c.default || c)
